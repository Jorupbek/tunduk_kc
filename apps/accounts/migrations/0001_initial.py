    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('Правление', 'Правление'), ('Совет Директоров', 'Совет Директоров'), ('Сотрудники', 'Сотрудники'), ('НАКС', 'НАКС')], max_length=20, verbose_name='Отдел')),
                ('position', models.CharField(max_length=300, verbose_name='Должность')),
                ('image', models.ImageField(blank=True, null=True, upload_to='profile', verbose_name='Фото профиля')),
